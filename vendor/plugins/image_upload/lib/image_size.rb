...
# image type list
  ...
  # Added, because duplicated img_data was captured after the original img_data was closed in windows.
  def close
    @img_data.close
  end
...
# define Singleton-method definition to String (byte, offset)
      ...
      # if @img_data.is_a?(IO) || @img_data.is_a?(StringIO) # Added StringIO
